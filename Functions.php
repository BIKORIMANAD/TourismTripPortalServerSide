...
public function sendEmail($email,$temp_password){
  ...
  $mail->SMTPAuth = true;
  $mail->Username = 'bikorimanadavid.rw@gmail.com';
  $mail->Password = 'Iwawe@2015';
  $mail->SMTPSecure = 'tls';
  $mail->Port = 587; 

  $mail->From = 'bikorimanadavid.rw@gmail.com';
  $mail->FromName = 'BIKORIMANA David';
  $mail->addAddress($email, 'BIKORIMANA David');
 
  $mail->addReplyTo('bikorimanadavid.rw@gmail.com', 'BIKORIMANA David');
